...
exports.default = /*@ngInject*/function ($scope) {
    ...
    _lodash2.default.extend(this, {
        level: 1,
        levels: Array.from({ length: 18 }, function (v, i) {
            return i + 1;
        }),
        rawmods: [],
        modsmap: [],

        update: function update(array, source) {
            var transform = arguments.length <= 2 || arguments[2] === undefined ? function (mod) {
                return mod;
            } : arguments[2];

            var modlist = array.length == 0 ? [] : array.map(function (item) {
                return item.mods.reduce(function (mods, mod) {
                    mod = (0, _objects.mix)(mod, { source: source });
            ...
            this.rawmods = this.rawmods.filter(function (mod) {
                return mod.source != source;
            }).concat(modlist);

            this.modsmap = this.rawmods.reduce(function (mods, mod) {
                if (!mods[mod.id]) {
                    mods[mod.id] = (0, _objects.mix)({}, mod);
                } else {
    ...
    $scope.$on('runes.updated', function ($event, runes) {
        _this.update(runes, ModSources.RUNES);
    });

    $scope.$on('masteries.updated', function ($event, masteries) {
        _this.update(masteries, ModSources.MASTERIES, function (mod, mastery) {
            return (0, _objects.mix)(mod, { value: mod.value * mastery.points });
        });
    });
};
...
},{"lib/objects":4,"lodash":"lodash"}],7:[function(require,module,exports){
'use strict';
...
exports.default = function () {
    return {
        ...
        replace: true,
        scope: {},
        templateUrl: 'stats/components/app/template.html',
...
exports.default = _angular2.default.module('stats.components.app', []).directive('suStatsApp', _directive2.default);
...
exports.default = _angular2.default.module('stats.components', [require('./stat').default.name, require('./stat-grid').default.name, require('./mod-list').default.name, require('./app').default.name]);

},{"./app":8,"./mod-list":12,"./stat":18,"./stat-grid":15,"angular":"angular"}],10:[function(require,module,exports){
'use strict';
...
exports.default = /*@ngInject*/function ($scope) {
    ...
    $scope.$on('mods.updated', function ($event, modsmap) {
        _this.mods = modsmap;
    });
};
...
exports.default = _angular2.default.module('stats.components.mod-list', []).directive('suStatsModList', _directive2.default);
...
exports.default = /*@ngInject*/function ($scope, gridStatsFilter) {
    var _this = this;
    ...
    _lodash2.default.extend(this, {
        ...
        recalculate: function recalculate(_ref) {
            var base = _ref.base;
            var mods = _ref.mods;
            var level = _ref.level;

            var stats = _fnjs2.default.map(base, function (stat) {
                if (stat) {
                    stat.value = stat.values ? _champions2.default.calculateStat(stat, stat.values, level) : 0;
                }
                return stat;
            });
            ...
            _fnjs2.default.forEach(mods, function (mod) {
                ...
                var value = mod.scaling ? mod.value * level : mod.value;
                ...
                var key = stat.id;
                if ([_modifiers.Stats.MANA_POOL.id, _modifiers.Stats.ENERGY_POOL.id, _modifiers.Stats.BLOODWELL.id].indexOf(mod.stat.id) > -1) {
                    key = 'RESOURCE';
                }
                if ([_modifiers.Stats.MANA_REGEN.id, _modifiers.Stats.ENERGY_REGEN.id].indexOf(mod.stat.id) > -1) {
                    key = 'RESOURCE_REGEN';
                }
                stats[key] = (0, _objects.mix)(stat, {
                    touched: true,
    ...
    $scope.$on('level.updated', function ($event, level) {
        _this.level = level;

        _this.stats = _this.recalculate({ base: _this.basestats, mods: _this.mods, level: _this.level });
    });

    $scope.$on('champion.updated', function ($event, champion) {
        _this.basestats = gridStatsFilter(champion ? champion.stats : {});
...
},{"fnjs":1,"lib/objects":4,"lodash":"lodash","services/champions":25,"services/modifiers":28}],14:[function(require,module,exports){
'use strict';
...
exports.default = _angular2.default.module('stats.components.stat-grid', []).directive('suStatsStatGrid', _directive2.default);
...
exports.default = _angular2.default.module('stats.components.stat', []).directive('suStatsStat', _directive2.default);
...
exports.default = /*@ngInject*/function () {
    return function (stats) {
        return _fnjs2.default.map(PreviewStats, function (stat) {
            if (Array.isArray(stat)) {
                stat = stat.map(function (stat) {
...
var PreviewStats = {
    ...
    ARMOR_PEN: _modifiers.Stats.ARMOR_PEN,

    MAGIC_PEN: _modifiers.Stats.MAGIC_PEN,

    PCT_ARMOR_PEN: _modifiers.Stats.PCT_ARMOR_PEN,

    PCT_MAGIC_PEN: _modifiers.Stats.PCT_MAGIC_PEN,

    LIFE_STEAL: _modifiers.Stats.LIFE_STEAL,

    SPELL_VAMP: _modifiers.Stats.SPELL_VAMP,

    ATTACK_RANGE: _modifiers.Stats.ATTACK_RANGE,

    TENACITY: _modifiers.Stats.TENACITY,

    ATTACK_DAMAGE: _modifiers.Stats.ATTACK_DAMAGE,

    MAGIC_DAMAGE: _modifiers.Stats.MAGIC_DAMAGE,
    ...
    CDR: _modifiers.Stats.CDR,

    CRIT_CHANCE: _modifiers.Stats.CRIT_CHANCE,

    MOVE_SPEED: _modifiers.Stats.MOVE_SPEED
};

},{"fnjs":1,"services/modifiers":28}],20:[function(require,module,exports){
'use strict';
...
exports.default = _angular2.default.module('stats.filters', []).filter('stat', require('./stat').default).filter('statIcon', require('./stat-icon').default).filter('statValue', require('./stat-value').default).filter('gridStats', require('./grid-stats').default);

},{"./grid-stats":19,"./stat":23,"./stat-icon":21,"./stat-value":22,"angular":"angular"}],21:[function(require,module,exports){
'use strict';
...
exports.default = /* @ngInject */function (decimalFilter) {
    return function (stat) {
        return populated(stat) ? (0, _strings.format)(Templates[stat.id] || Templates.DEFAULT, {
...
}, _defineProperty(_Templates, _modifiers.Stats.PCT_ARMOR_PEN.id, '${value}%'), _defineProperty(_Templates, _modifiers.Stats.PCT_MAGIC_PEN.id, '${value}%'), _defineProperty(_Templates, _modifiers.Stats.LIFE_STEAL.id, '${value}%'), _defineProperty(_Templates, _modifiers.Stats.SPELL_VAMP.id, '${value}%'), _defineProperty(_Templates, _modifiers.Stats.CRIT_CHANCE.id, '${value}%'), _defineProperty(_Templates, _modifiers.Stats.CDR.id, '${value}%'), _Templates);
...
},{"lib/strings":5,"services/modifiers":28}],23:[function(require,module,exports){
'use strict';

var _StatDescriptions;
...
exports.default = /* @ngInject */function (decimalFilter) {
    return function (mod, prop) {
        ...
        if (prop == 'value') {
            ...
            var valuePerLevel = mod.value * (percent ? 100 : 1);
            var value = mod.scaling ? valuePerLevel * 18 : valuePerLevel;
            ...
            var perLevelText = mod.scaling ? '(' + decimalFilter(valuePerLevel, 2) + ' per level)' : '';

            var operator = value < 0 || mod.stat.id == _modifiers.Stats.TIME_DEAD.id ? '-' : '+';
...
var StatDescriptions = (_StatDescriptions = {}, _defineProperty(_StatDescriptions, _modifiers.Stats.HEALTH_POOL.id, 'Health'), _defineProperty(_StatDescriptions, _modifiers.Stats.MANA_POOL.id, 'Mana'), _defineProperty(_StatDescriptions, _modifiers.Stats.HEALTH_REGEN.id, 'Health Regeneration (per 5 sec)'), _defineProperty(_StatDescriptions, _modifiers.Stats.MANA_REGEN.id, 'Mana Regeneration (per 5 sec)'), _defineProperty(_StatDescriptions, _modifiers.Stats.ENERGY_POOL.id, 'Energy'), _defineProperty(_StatDescriptions, _modifiers.Stats.ENERGY_REGEN.id, 'Energy Regeneration (per 5 sec)'), _defineProperty(_StatDescriptions, _modifiers.Stats.ARMOR.id, 'Armor'), _defineProperty(_StatDescriptions, _modifiers.Stats.MAGIC_RESIST.id, 'Magic Resistance'), _defineProperty(_StatDescriptions, _modifiers.Stats.ARMOR_PEN.id, 'Armor Penetration'), _defineProperty(_StatDescriptions, _modifiers.Stats.MAGIC_PEN.id, 'Magic Penetration'), _defineProperty(_StatDescriptions, _modifiers.Stats.PCT_ARMOR_PEN.id, 'Armor Penetration (%)'), _defineProperty(_StatDescriptions, _modifiers.Stats.PCT_MAGIC_PEN.id, 'Magic Penetration (%)'), _defineProperty(_StatDescriptions, _modifiers.Stats.CDR.id, 'Cooldown Reduction'), _defineProperty(_StatDescriptions, _modifiers.Stats.MAX_CDR.id, 'Maximum CDR'), _defineProperty(_StatDescriptions, _modifiers.Stats.MAGIC_DAMAGE.id, 'Ability Power'), _defineProperty(_StatDescriptions, _modifiers.Stats.ATTACK_SPEED.id, 'Attack Speed'), _defineProperty(_StatDescriptions, _modifiers.Stats.ATTACK_DAMAGE.id, 'Attack Damage'), _defineProperty(_StatDescriptions, _modifiers.Stats.CRIT_CHANCE.id, 'Critical Chance'), _defineProperty(_StatDescriptions, _modifiers.Stats.CRIT_DAMAGE.id, 'Critical Damage'), _defineProperty(_StatDescriptions, _modifiers.Stats.MOVE_SPEED.id, 'Movement Speed'), _defineProperty(_StatDescriptions, _modifiers.Stats.LIFE_STEAL.id, 'Life Steal'), _defineProperty(_StatDescriptions, _modifiers.Stats.SPELL_VAMP.id, 'Spell Vampirism'), _defineProperty(_StatDescriptions, _modifiers.Stats.TIME_DEAD.id, 'Time Spent Dead'), _defineProperty(_StatDescriptions, _modifiers.Stats.GP10.id, 'Gold per 10 sec'), _defineProperty(_StatDescriptions, _modifiers.Stats.PCT_XP.id, 'Experience Gained'), _defineProperty(_StatDescriptions, _modifiers.Stats.ABILITY_DAMAGE.id, 'Ability Damage'), _defineProperty(_StatDescriptions, _modifiers.Stats.TENACITY.id, 'Tenacity'), _defineProperty(_StatDescriptions, _modifiers.Stats.DAMAGE_TAKEN.id, 'Damage Taken'), _defineProperty(_StatDescriptions, _modifiers.Stats.DAMAGE_DEALT.id, 'Damage Dealt'), _StatDescriptions);

;

},{"services/modifiers":28}],24:[function(require,module,exports){
'use strict';
...
exports.default = _angular2.default.module('stats', ['ngRaven', 'stats.templates', 'common', require('./filters').default.name, require('./components').default.name]);

},{"./components":9,"./filters":20,"angular":"angular","angular-raven":"angular-raven"}],25:[function(require,module,exports){
'use strict';
...
},{"data/7.6.1/champions":2,"services/ddragon":26,"services/globals":27,"services/modifiers":28,"transformers/champions":29}],26:[function(require,module,exports){
'use strict';
...
},{"lib/http":3,"lib/strings":5,"services/globals":27}],27:[function(require,module,exports){
'use strict';
...
},{"lib/objects":4}],29:[function(require,module,exports){
'use strict';
...
},{"fnjs":1,"lib/objects":4,"services/modifiers":28}]},{},[24])
